...
| EXT-012 | Allocation | Production allocation policy overrides and live COI register/import source | Build S09 from `docs/implementation/source-reconciliation.md`; keep distance thresholds, country/operator judge-count variants, second-judge extensions, and COI import source configurable | Production allocation/UAT sign-off |
