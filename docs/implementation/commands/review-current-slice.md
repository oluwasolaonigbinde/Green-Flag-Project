...
- Keep current active status.
- Record the issue, source references, options, and reviewer recommendation in `current-implementation-review.md`.
- Do not pass, fail, block, or close the slice until the human decision is recorded.
